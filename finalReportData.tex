...
\chapterabstract{A study and critique of the existing no-code ML landscape ---
why each family of tools falls short on data sovereignty --- followed by the
...
\section{Fondements techniques retenus}
...
data-science lifecycles (CRISP-DM for ML, and MLOps practices for the AI sprints)
--- together with the toolchain and the microservice architecture those choices
produced.}
% ═════════════════════════════════════════════════════════════════════════════
...
\begin{itemize}
    \item \textbf{Sprint~2 (tabular ML)} follows \textbf{CRISP-DM} ---
...
\section{Cycle de vie RAG (LLMOps)}
...
\section{Cycle de vie deep learning}
...
\begin{itemize}
    ...
    \item \texttt{docs/} --- the demo-day runbook, the report audit
        notes, the PFE submission decks (FR + EN), and the
        tour-captured screenshots.
