...
\begin{figure}[H]
  ...
  \caption{A complete tabular ML pipeline assembled on the canvas: Dataset $\to$ Train $\to$ Evaluate.}
...
\begin{figure}[H]
  ...
  \caption{A complete RAG pipeline assembled on the canvas: Document $\to$ Vector Store $\to$ Chat.}
