...
class User(db.Model):
    ...
    email_verification_token_hash = db.Column(db.String(255), nullable=True, index=True)
    email_verification_sent_at = db.Column(db.DateTime(timezone=True), nullable=True)
    password_reset_token_hash = db.Column(db.String(255), nullable=True, index=True)
    ...
    has_seen_genai_tour = db.Column(db.Boolean, nullable=False, default=False)
    has_seen_dl_tour = db.Column(db.Boolean, nullable=False, default=False)
