...
% [FIGURE NEEDED: Annotated mockup of the landing page showing the hero, three pillar cards (ML/RAG/DL), and primary call-to-action]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch1_fig1}
...
% [FIGURE NEEDED: High-level deployment diagram showing host machine, GPU, Docker network, named volumes, and the external Stripe boundary]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch1_fig2}
...
% [FIGURE NEEDED: Authentication screen mockup with email/password and an optional TOTP entry tile]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch1_fig3}
%   \caption{Authentication interface --- email/password with optional TOTP.}
%   \label{fig:ch1_fig3}
% \end{figure}

% [FIGURE NEEDED: Authenticated home page mockup --- left sidebar, datasets and pipelines cards, quota panel]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch1_fig4}
...
% [FIGURE NEEDED: 2x2 positioning matrix --- axes are "Privacy (local vs cloud)" and "Approachability (code vs no-code)" --- shows the four families plus this project]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch2_fig1}
...
% [FIGURE NEEDED: Bar chart showing FP16/Q8/Q5/Q4 quantisation footprints for a 3B model, with a horizontal line at 6 GB indicating the demo-box ceiling]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch2_fig2}
...
% [FIGURE NEEDED: Scrum framework diagram with the three roles, three artefacts, and five events]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch3_fig1}
...
% [FIGURE NEEDED: Gantt chart showing planned vs actual duration for each of the six sprints, with overruns annotated]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_ch3_fig2}
...
% [FIGURE NEEDED: Microservice topology diagram --- gateway, five services, three Celery workers, four data stores, Ollama, message bus, with port numbers]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_ch3_fig3}
%   \caption{High-level microservice topology.}
%   \label{fig:ch3_fig3}
% \end{figure}

% [FIGURE NEEDED: General use-case diagram --- every actor (Visitor, Free user, Solo user, Company user, Project Manager, Data Scientist, Analyst, Viewer, Super-admin) connected to every major use case (Sign-up, Verify email, Reset password, Upload dataset, Build pipeline, Train ML, Train RAG, Train DL, Manage members, Admin operations). Landscape to fit.]
% \begin{landscape}
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\linewidth]{figures/placeholder_ch3_fig_general_usecase}
%   \caption{General use-case diagram --- complete actor / use-case map across the six sprints.}
%   \label{fig:ch3_fig_general_usecase}
% \end{figure}
% \end{landscape}

% [FIGURE NEEDED: Database schema --- ER-style diagram of every Postgres table (users, refresh_tokens, subscriptions, companies, memberships, invitations, pipeline_members, audit_logs, announcements, rag_documents, rag_chunks). Landscape to fit relationships without crossing.]
% \begin{landscape}
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\linewidth]{figures/placeholder_ch3_fig_db_schema}
...
% [FIGURE NEEDED: Use case diagram for Sprint 1 --- actors (user, super-admin) and the auth + ingestion use cases]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch4_fig1}
%   \caption{Use case diagram --- authentication and ingestion.}
%   \label{fig:ch4_fig1}
% \end{figure}

% [FIGURE NEEDED: Sequence diagram for login + JWT issuance + refresh-token rotation through the gateway]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch4_fig2}
%   \caption{Sequence diagram --- login plus refresh-token rotation.}
%   \label{fig:ch4_fig2}
% \end{figure}

% [FIGURE NEEDED: Sequence diagram for asynchronous CSV upload --- browser to API to shared volume to Celery worker to Mongo]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch4_fig3}
%   \caption{Sequence diagram --- upload plus asynchronous profiling.}
%   \label{fig:ch4_fig3}
% \end{figure}

% [FIGURE NEEDED: Class diagram covering User, RefreshToken, Subscription, Dataset, ProfilingResult]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch4_fig4}
...
% [FIGURE NEEDED: Login screen screenshot with optional TOTP entry]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.75\textwidth]{figures/placeholder_ch4_fig5}
%   \caption{Login screen with optional TOTP field.}
%   \label{fig:ch4_fig5}
% \end{figure}

% [FIGURE NEEDED: SQL connector wizard screenshot --- credentials, test connection, save]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch4_fig6}
%   \caption{SQL connector wizard --- credentials encrypted at rest.}
%   \label{fig:ch4_fig6}
% \end{figure}

% [FIGURE NEEDED: Sequence diagram for the password-reset round-trip --- user requests forgot-password, auth-service mints token + persists hash, mail-service sends to MailHog, user clicks link, frontend POSTs token + new password, auth-service validates TTL and revokes refresh tokens, user signs in with new password.]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch4_fig_seq_password_reset}
...
% [FIGURE NEEDED: CRISP-DM six-phase cycle diagram --- Business Understanding / Data Understanding / Data Preparation / Modelling / Evaluation / Deployment arranged in a circle with arrows. Centre node: the canvas pipeline.]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.7\textwidth]{figures/placeholder_ch5_fig_crispdm}
...
% [FIGURE NEEDED: Use case diagram for Sprint 2 --- canvas, training, evaluation, comparison, export]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch5_fig1}
%   \caption{Use case diagram --- canvas plus tabular ML.}
%   \label{fig:ch5_fig1}
% \end{figure}

% [FIGURE NEEDED: Class diagram showing BaseMLModel and its fourteen subclasses, grouped by ecosystem (sklearn / H2O / boosters / Prophet)]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch5_fig2}
...
% [FIGURE NEEDED: Use-case refinement diagram for "Train ML model" --- expanded into sub-cases: Pick algorithm, Set hyperparameters, Select target column, Configure split, Trigger run, Inspect live metrics, Review SHAP, Promote to default, Export.]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch5_fig_uc_refine_train}
%   \caption{Use-case refinement --- ``Train ML model'' broken into sub-cases.}
%   \label{fig:ch5_fig_uc_refine_train}
% \end{figure}

% [FIGURE NEEDED: Sequence diagram for tabular ML training --- browser POSTs /pipelines/<id>/run, gateway forwards to ml-training-service, service enqueues Celery task, worker loads dataset from shared volume, preprocesses (split, impute, scale, encode), instantiates BaseMLModel subclass, fits, computes metrics + SHAP, persists artefact to Mongo, emits training_complete on SocketIO, frontend renders results.]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_ch5_fig_seq_training}
%   \caption{Sequence diagram --- tabular ML training, browser to artefact.}
%   \label{fig:ch5_fig_seq_training}
% \end{figure}

% [FIGURE NEEDED: State diagram for the pipeline lifecycle --- states: draft, running, done, error; transitions: Save (draft->draft), Run (draft->running), worker success (running->done), worker failure (running->error), Edit (done->draft), Retry (error->running).]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.7\textwidth]{figures/placeholder_ch5_fig_state_pipeline}
...
% [FIGURE NEEDED: Live training chart screenshot --- dual Y axes, progress curve, metric curve]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch5_fig5}
...
% [FIGURE NEEDED: SHAP feature importance bar chart for the reference salary regression run]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch5_fig6}
...
% [FIGURE NEEDED: Use case diagram for Sprint 3 --- ingest document, configure RAG, chat with context]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch6_fig1}
%   \caption{Use case diagram --- RAG pipeline.}
%   \label{fig:ch6_fig1}
% \end{figure}

% [FIGURE NEEDED: Sequence diagram for ingest-then-chat --- document upload, chunking, embedding, pgvector insert, question retrieval, Ollama generation, streamed reply]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_ch6_fig2}
%   \caption{Sequence diagram --- document to embed to store to chat.}
%   \label{fig:ch6_fig2}
% \end{figure}

% [FIGURE NEEDED: Class diagram --- DocumentChunk, EmbeddingVector, RAGConfig, ChatThread, ChatMessage]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch6_fig3}
...
% [FIGURE NEEDED: RAG chat panel screenshot --- question, streamed answer, source-chunks chip with similarity scores]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch6_fig4}
...
% [FIGURE NEEDED: Use case diagram for Sprint 4 --- upload image dataset, configure architecture, train, predict]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch7_fig1}
%   \caption{Use case diagram --- DL pipeline.}
%   \label{fig:ch7_fig1}
% \end{figure}

% [FIGURE NEEDED: DL service architecture --- API container, Celery worker with GPU reservation, model registry volume, VRAM guard]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_ch7_fig2}
%   \caption{Architecture --- \texttt{dl-training-service}, Celery worker, GPU allocation.}
%   \label{fig:ch7_fig2}
% \end{figure}

% [FIGURE NEEDED: Class diagram --- ArchitectureCatalog (LeNet/TinyResNet/MobileNetV3), VRAMGuard, TrainRequest, TrainResult]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch7_fig3}
%   \caption{Class diagram --- architecture catalogue plus VRAM guard.}
%   \label{fig:ch7_fig3}
% \end{figure}

% [FIGURE NEEDED: Sequence diagram for the DL training flow, split across two stacked subfigures.
%   (a) Validation phase: POST /dl/train -> gateway -> dl-training-service -> tier-ceiling check -> VRAM-guard estimate; rejection branch returns 400 with structured payload.
%   (b) Training phase (only reached on validation success): enqueue Celery task -> worker loads ImageFolder dataset -> instantiates arch from catalogue -> training loop emits training_epoch on SocketIO -> save state_dict -> emit training_complete -> Try-It panel renders.]
% \begin{figure}[H]
%   \centering
%   \begin{subfigure}{0.95\textwidth}
%     \centering
%     \includegraphics[width=\linewidth]{figures/placeholder_ch7_fig_seq_training_a}
...
%   \begin{subfigure}{0.95\textwidth}
%     \centering
%     \includegraphics[width=\linewidth]{figures/placeholder_ch7_fig_seq_training_b}
...
% [FIGURE NEEDED: Activity diagram for the 4-layer VRAM-guard defence chain. Swimlanes: Frontend / Route / VRAM-Guard / Hard-Cap. Start: user drags slider. Decision diamond at each layer: (1) slider clamps to tier ceiling -> (2) route rejects if posted value exceeds tier -> (3) static estimator computes total_mb, rejects if > budget-1GB -> (4) HARD_MAX cap rejects regardless. Success path enqueues Celery task.]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_ch7_fig_activity_vram_guard}
...
% [FIGURE NEEDED: Use case diagram for Sprint 5 --- owner, project manager, data scientist, analyst, viewer]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch8_fig1}
%   \caption{Use case diagram --- collaboration roles and actions.}
%   \label{fig:ch8_fig1}
% \end{figure}

% [FIGURE NEEDED: Sequence diagram --- two clients join a pipeline room, cursor and node-selection events fan out]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_ch8_fig2}
%   \caption{Sequence diagram --- cursor and node-selection events over SocketIO.}
%   \label{fig:ch8_fig2}
% \end{figure}

% [FIGURE NEEDED: Class diagram --- Pipeline, PipelineMembership, ChatThread, ChatMessage, MeetLink]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch8_fig3}
%   \caption{Class diagram --- pipeline membership, chat threads, Meet integration.}
%   \label{fig:ch8_fig3}
% \end{figure}

% [FIGURE NEEDED: Use-case refinement diagram for "Manage Pipeline membership" --- sub-cases: Invite by email, Change role, Remove member, Transfer ownership, View audit log. Actors: Owner, Project Manager.]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch8_fig_uc_refine_pipeline}
...
% [FIGURE NEEDED: Use case diagram for Sprint 6 --- user dashboard, admin operations]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch9_fig1}
%   \caption{Use case diagram --- dashboard plus admin operations.}
%   \label{fig:ch9_fig1}
% \end{figure}

% [FIGURE NEEDED: Dashboard wireframe --- tabs for datasets/pipelines/models, quota panel, manage-plan link]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch9_fig2}
%   \caption{Wireframe --- user dashboard with datasets, pipelines, versions.}
%   \label{fig:ch9_fig2}
% \end{figure}

% [FIGURE NEEDED: Class diagram --- Notification, AuditLogEntry, ImpersonationToken, Announcement]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch9_fig3}
%   \caption{Class diagram --- notifications, audit log, impersonation token.}
%   \label{fig:ch9_fig3}
% \end{figure}

% [FIGURE NEEDED: Sequence diagram for admin impersonation --- super-admin clicks eye icon, auth-service mints a 5-min token with imp_actor claim, frontend swaps tokens in sessionStorage and shows the red banner, every subsequent request carries the impersonation token, on Exit or TTL expiry the original super-admin token is restored, audit_logs gets impersonate_start + impersonate_end entries.]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_ch9_fig_seq_impersonate}
...
% [FIGURE NEEDED: User dashboard screenshot --- three tabs, paginated tables, quota panel]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_ch9_fig4}
%   \caption{User dashboard --- datasets, pipelines, model versions, quota.}
%   \label{fig:ch9_fig4}
% \end{figure}

% [FIGURE NEEDED: Billing page screenshot --- tier comparison, current plan, manage-in-Stripe link]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch9_fig5}
...
% [FIGURE NEEDED: Side-by-side screenshot --- the same page in English and in French]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_ch9_fig6}
...
% [FIGURE NEEDED: Admin operations dashboard screenshot --- five-panel layout]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_ch9_fig7}
...
% [FIGURE NEEDED: Backend coverage report screenshot --- per-service line coverage]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch10_fig1}
...
% [FIGURE NEEDED: Frontend coverage report screenshot --- vitest output with coverage percentages]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch10_fig2}
...
% [FIGURE NEEDED: CI/CD pipeline flow diagram --- GitHub push triggers GitHub Actions; four parallel jobs (backend lint, frontend lint, backend tests with PG+Mongo+Redis services, frontend vitest); on green, image build step pushes to local registry; on red, PR check blocks merge. Show the matrix.service expansion for the dl-training-service CPU-wheel branch.]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_ch10_fig_cicd_flow}
...
% [FIGURE NEEDED: Deployment diagram --- 14 containers laid out by role, three named volumes, single host boundary]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_ch10_fig5}
...
% [FIGURE NEEDED: Network topology --- gateway as single ingress, internal Docker network, no direct access to data stores]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figures/placeholder_ch10_fig6}
...
% [FIGURE NEEDED: Final results dashboard --- tabular validation card on the left, DL validation card on the right]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.95\textwidth]{figures/placeholder_conclusion_fig1}
