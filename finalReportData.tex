...
% [SCREENSHOT NEEDED: ml_run_results.png — results dashboard after a completed ML run: metric summary card + confusion matrix / residual plot]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.9\textwidth, keepaspectratio]{diagrams/ml_run_results}
%   \caption{Tabular ML results after a completed run --- metric summary and confusion matrix.}
