...
os.environ.setdefault("MONGO_URL", "mongodb://test:test@localhost:27017/test_training?authSource=admin")
...
def app():
    ...
    with patch("app.main.mongo") as mock_mongo, \
         patch("app.main.mail") as mock_mail:
